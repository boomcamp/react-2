...
class EmployeeEditor extends Component {
  ...
  save(){
    ...
    oe.updateName(this.state.employee.name);
    oe.updatePhone(this.state.employee.phone);
    oe.updateTitle(this.state.employee.title);
